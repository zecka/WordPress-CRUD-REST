...
class ZKAPI_Mail{
    ...
    public function __construct($args=array()){
        $properties = ['from_name', 'to', 'subject', 'reply_to', 'content'];
    ...
    public function send(){
        if($this->to && $this->subject && $this->content){
            ...
            $mail = wp_mail($this->to, $this->subject, $this->html_mail_content(), $this->get_headers());
    ...
    /**
     * HTML GENERATE WITH : stripo.email
     */
    private function html_mail_content(){
        $primary_color = "#ff4d3b";
        ob_start();?>
                ...
                <table class="es-header-body" align="center" cellpadding="0" cellspacing="0" width="600" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:transparent;"> 
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;"> 
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;"> 
                            ...
                            <a href="<?php echo home_url(); ?>" target="_blank" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:14px;text-decoration:underline;color:#1376C8;">
                                <img src="<?php echo get_template_directory_uri() ?>/assets/img/logo-360.png" alt width="180" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;"></a></td> 
                            </tr> 
                        </table></td> 
                        </tr> 
                    </table></td> 
